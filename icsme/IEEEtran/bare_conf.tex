...
Figure 1 shows the numbers of concurrent related commits and all commits of each month in all projects of our study. It also shows the percentage of concurrent related commits. Each subfigure has two subsubfigures. The number of concurrent related commits is relatively small compared to the number of all commits as we can see in Figure 1. The two indexes have a positive correlation generally.
