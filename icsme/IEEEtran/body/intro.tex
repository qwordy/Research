...
In this paper, we conducted an empirical study on 98,352 commits that were collected six popular and representative open-source projects. In total, we selected 695 concurrency-related commits from our collected commits, and carefully analyzed our extracted commits. Based on our results, this paper makes the following contributions:
