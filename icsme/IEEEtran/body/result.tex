...
Programmers can change their lock types due to various considerations. For example, the \CodeIn{synchronized} keyword cannot suffice to the situation where most operations are not repulsive, in which case a reader-writer lock is more suitable.
