...
We find that programmers can also delete unnecessary locks. For example, the fifth item of Table~\ref{table:patterns} comes from Flink. \zhong{The URL or issue number}.
...
In some reported bugs, the locks on variables cause deadlocks. For example, the sixth item of Table~\ref{table:patterns2} is reported in FLINK-2384. It reports a deadlock, and the following stack trace is attached:
