...
We find that programmers can also delete unnecessary locks. For example, the fifth item of Table~\ref{table:patterns} comes from Flink\footnote{\url{https://github.com/apache/flink/commit/c93d9eaf363a535dff25cc4e7db400d879e73bb1}}.
