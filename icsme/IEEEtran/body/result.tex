...
Once developers know and understand these change patterns well in concurrent programming, they can refer to these change patterns to see whether one of them matches the condition when they are writing or maintaining concurrent code. However, we use a keyword search method to find possible code context to apply the change patterns.
