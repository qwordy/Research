...
\textbf{RQ1. Determining change patterns.} To explore this research question, we get 696 concurrency-related commits selected from our tool. However, we find many changes are similar when we begin to inspect these commits. So we randomly inspect half of the commits of each project.

%we sampled ? concurrency-related commits for manual inspection.
%\zhong{How did you sample the commits?}
