...
\textbf{RQ4. Determining the correlations between commits and concurrency commits} We count the number of commits and concurrency commits in each month respectively. We use Spearman's rank correlation coefficient to measure how two variables are correlated. The result is positive. The average coefficient is 0.726.%\zhong{Please explain what measure do you use to determine the correlations}
