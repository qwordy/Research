...
\textbf{RQ1. Determining change patterns.} To explore this research question, we manually inspect 696 concurrency-related commits selected from our tool.

%we sampled ? concurrency-related commits for manual inspection. \zhong{How did you sample the commits?}
