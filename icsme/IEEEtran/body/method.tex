...
\textbf{RQ1. Determining change patterns.} To explore this research question, we select 696 concurrency-related commits. Due to the heavy manual effort, we randomly sample some commits from each project. We then analyze each sampled commits for their change patterns. For example, the below is a concurrency-related commit. The top five lines describe the metadata of the commit. The other lines describe the differences between two versions of code.
