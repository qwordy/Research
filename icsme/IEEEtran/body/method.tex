...
correlation coefficient calculates a correlation value $r$ between -1 and +1. Cohen~\cite{bibid} defines, $0.1 < |r| < 0.3$ as small correlation, $0.3 \leq |r| < 0.5$ as moderate correlation, and $|r| \geq 0.5$ as strong correlation. Here, -1 also denotes a strong monotonic negative correlation.
