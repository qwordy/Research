...
\noindent
\textbf{The causes of reverted commits.} We find that different programmers can make opposite changes. For example, we find the following The first commit is from Cassandra:
