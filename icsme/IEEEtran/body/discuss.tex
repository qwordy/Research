...
\noindent
\textbf{The usefulness of our other findings.} Our result of the trend of change frequency can help programmers understand what concurrent classes are heavily used and what concurrent classes are gradually abandoned.% We can pay more attention to the active classes.\zhong{analyzing how to use the results of RQ3 and RQ4 in future work.}
