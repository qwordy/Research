...
\noindent
\textbf{The extension of existing tools.} \zhong{Explain how to improve existing tools with your findings. Discuss how to implement a tool that, for example, that can replace self code with existing parallel APIs. }