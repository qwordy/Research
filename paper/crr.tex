...
Research shows that software modifications are usually similar but not identical. One reason is when code clone need to change, the changes have similarities.
