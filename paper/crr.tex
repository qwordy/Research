...
\title{An empirical study on concurrent related code evolution\titlenote{(Produces the permission block, and
...
\textbf{RQ1.} How frequent do concurrent related code appear in popular open-source project?

\textbf{RQ2.} How often does developer use new concurrent libraries instead of the old ones?

\textbf{RQ3.} Is there any cross-project change routine about concurrent API usage?
 

\section{Methodology}
\textbf{Project Source} Concurrent programs are pervasive among Java software projects. We investigate some famous and representative Java open-source projects including hadoop, tomcat, lucene and so on.
