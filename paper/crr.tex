...
\textbf{RQ1.} How frequent do concurrent related code appear in popular open-source projects?
...
\section{Methodology}
This section presents the methodology of our study. 
...
\textbf{Checking out versions}
All the projects selected are under git which is one of the most popular version control systems in the world.

\subsection{Calculating context similarity}

\subsection{Extracting changes}

\subsection{Calculating change similarity}
